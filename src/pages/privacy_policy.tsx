...
<ul>
  ...
  <li>
    <p>
      ...
      refers to Smiles Car Rental, 10 College Avenue West.
    </p>
  </li>
  <li>
    <p>
  ...
  <li>
    <p>
      <strong>Website</strong> refers to Smiles Car Rental, accessible from
      <a
        href="www.smilesrental.com"
        rel="external nofollow noopener"
        target="_blank"
        >www.smilesrental.com</a
      >
    </p>
  </li>
  <li>
...
<ul>
  <li>By email: admin@smilesrental.com</li>
</ul>
